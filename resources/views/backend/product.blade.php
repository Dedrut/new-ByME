...
@section('titleHalaman', 'Admin - Produk')
    ...
    <div class="modal-dialog modal-dialog-scrollable">
      <div class="modal-content">
        ...
        <div class="modal-body">
            <div class="mb-3">
                <label for="inProductName" class="form-label">Nama Produk</label>
            ...
            <div class="mb-3">
                ...
                <div class="input-group">
                    <textarea placeholder="Masukkan Deskripsi" class="form-control" name="inDeskripsi" id="inDeskripsi" required></textarea>
                </div>              
            </div>
            <div class="mb-3">
                <label for="inGambar" class="form-label">Gambar Produk</label>
                <div class="input-group">
                    <input type="file" placeholder="Masukkan Gambar Produk" class="form-control" name="inGambar" id="inGambar" required>
                </div>                
            </div>
            <div class="mb-3">
                <label for="inCategoryName" class="form-label">Kategori</label>
                <div class="input-group">
                    <select name="inCategoryName" id="inCategoryName" class="form-select" required>
            ...
            <div class="mb-3">
                <label for="inJumlah" class="form-label">Jumlah Produk</label>
                <div class="input-group">
                    <input type="number" placeholder="Masukkan Jumlah Produk" class="form-control" name="inJumlah" id="inJumlah" required>
                </div>                                
            </div>
            <div class="mb-3">
                <label for="inHarga" class="form-label">Harga Produk</label>
                <div class="input-group">
                    <input type="number" placeholder="Masukkan Harga Produk" class="form-control" name="inHarga" id="inHarga" required>
                </div>                                
            </div>        
        </div>
